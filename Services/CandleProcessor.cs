...
public class CandleProcessor : ICandleProcessor
{
    ...
    public CandleProcessor(IBinanceService binanceService,ICoinsRepository coinsRepository, ICandlesRepository candlesRepository, string symbol, int secondsTimeSpan)
    {
